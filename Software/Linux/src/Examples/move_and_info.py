...
def decode_ucp_0x05(frame):
    ...
    acc_g = [v / 16384.0 for v in (acc_x, acc_y, acc_z)]      # ±2 g range
    acc_ms2 = [a * 9.80665 for a in acc_g]
    gyro_dps = [v / 131.0 for v in (gyro_x, gyro_y, gyro_z)]  # ±250 °/s range
    mag_uT = [v * 0.083 for v in (mag_x, mag_y, mag_z)]       # QMC5883L sensitivity
...
if __name__ == "__main__":
    ...
    try:
        ...
        # robot_move(sock, duration=1.0, speed=100, angular=0)
